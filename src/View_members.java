...
public class View_members extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Viewing_the_members
     */
    public View_members() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Member_Id ", "First_Name", "Last_Name", "Phone_No", "Membership_Date ", "Expiry", "House_No", "Locality", "City", "State", "Pincode"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 1102, 198));

        btn_view.setFont(new java.awt.Font("Yu Gothic UI", 1, 16)); // NOI18N
        btn_view.setText("VIEW THE MEMBERS");
        btn_view.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_viewActionPerformed(evt);
            }
        });
        getContentPane().add(btn_view, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 250, -1, -1));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1140, 300));
    ...
    if(rows>0)
    {
      ...
      try{
        ...
        while(rs.next())
        {
             ...
             model.addRow(new Object[]{Member_Id,First_Name,Last_Name,Phone_No,Membership_Date,Expiry,House_No,Locality,City,State,Pincode});
